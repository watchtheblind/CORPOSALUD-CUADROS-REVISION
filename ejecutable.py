...
# ESTRUCTURA DEL MAPEO: "NOMBRE": [NOMBRE DE COLUMNA EN EL LIBRO CARGA, NOMBRE DE COLUMNA EN LA PLANTILLA]
MAPEO_COLUMNAS = {
    "CEDULA": ["CEDULA", "CEDULA"],
    "SEXO": ["SEXO", "SEXO"],
    "1ERNOM": ["1ER NOMBRE", "1ER NOMBRE"],
    "2DONOM":["2DO NOMBRE", "2DO NOMBRE"],
    "1ERAPE":["1ER APELLIDO", "1ER APELLIDO"],
    "2DOAPE": ["2DO APELLIDO", "2DO APELLIDO"],
    "DESC_CARGO": ["DESC. CARGO", "DESC. CARGO"],
    "UBIC_ADMIN": ["UBICACION ADMINISTRATIVA", "UBICACION ADMINISTRATIVA"],
    "COD_RAC": ["COD. CARGO", "CODIGO RAC"],
    "NIVEL": ["NIVEL CARGO", "NIVEL CARGO"],
    "GRADO": ["GRADO", "GRADO"],
    "HORAS": ["CARGA HORARIA", "CARGA HORARIA"],
    "ESP_MED": ["ESPECIALIDAD MÉD 1", "ESPECIALIDAD MÉD 1"],
    "ESP_MED2": ["ESPECIALIDAD MÉD 2", "ESPECIALIDAD MÉD 2"],
    "UBIC_FISICA": ["UBICACION FISICA", "UBICACION FISICA"],
    ...
    "CODIGO_NOMINA": ["COD. NOMINA", "COD. NOMINA"],
    "CODIGO_CARGO": ["COD. CARGO", "COD. CARGO"],
    ...
    "F_INACTIVA": ["FECHA INACTIVACIÓN", "FECHA DE INACTIVACION"],
    "P_ANTIG": ["PORC ANTIGUEDAD", "PORC ANTIGUEDAD"],
    "P_ESCAL": ["PORC ESCALAF", "PORC ESCALAF"],
    "HIJOS": ["NRO HIJOS", "NRO HIJOS"],
    ...
    "C114": ["111.4 COMP. EVAL. 2DO SEM 2022", "111.4 COMP. EVAL. 2DO SEM 2023"],
